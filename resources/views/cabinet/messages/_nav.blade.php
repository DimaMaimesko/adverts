...
<ul class="nav nav-tabs mb-3">
    ...
    <li class="nav-item"><a class="nav-link active" href="{{ route('cabinet.messages.index') }}">Messages  <span class="badge badge-danger">{{isset($counter) ? $counter : null }}</span></a></li>
